...
public class AVRConstants {
    ...
    public static final boolean USE_TATA_LOCALISED_BMP = true;
    public static final boolean USE_MORPHOLOGICAL_CROPPING = false;
    ...
    public static final int maxPixelConnectivity = 5;
